...
<div>
  ...
  <div class="grid gap-3 grid-cols-12">
      ...
      <div class="mt-3 col-span-9">
          ...
          class="block text-sm font-medium tetx-gray-700"
          >
          Question Text
          </label>
          <input type="text"
      ...
      <div class="mt-3 col-span-3">
          ...
          "
          >
            <option v-for="types in questionTypes" :key="types.id" :value="types">
    ...
    <div class="mt-3 col-span-9">
        <label for="'question_desciption' + model.id"
    ...
    <!-- Data -->
    <div>
        <div v-if="shouldHaveOptioins()" class="mt-2">
            ...
            <div 
                ...
                You don't have anp options defined
            </div>
            <!-- Option list -->
