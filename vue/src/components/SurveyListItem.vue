<template>
   <div class="
        ...
        <div class="flex justify-between items-center mt-5">
            ...
            class="
            flex py-2 px-2 border border-transparent text-sm rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus: ring-indigo-500
            "
            > <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-5" fill="none" viewBox="0 0 20 20" stroke="currentColor">
