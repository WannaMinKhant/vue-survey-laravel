    ...
    <div>
        <PageComponent title="Dashboard">
            ...
            > 
                ...
                <div 
                class ="row-span-2 order-3 bg-white shadow p-4 lg:order-1 animate-fade-in-down"
                style="animation-delay:0.1s"
                >
                    <h3 class="text-2xl font-semibold">Total Surveys</h3>
                    <img
                    ...
                    <div class="flex justify-between">
                        ...
                        text-sm rounded-md text-indigo-500
                ...
                <div 
                class ="row-span-2 order-4 bg-white shadow p-3 lg:order-3 animate-fade-in-down"
